    ...
    public static void main(String[] args) throws PcapNativeException, NotOpenException, IllegalRawDataException {
        ...
        while (true) {
            ...
            if (packet == null) {
                ...
                int tipo = tipo_b1 + tipo_b2; //suma binariax
                ...
                if (tipo >= 1500) {
                    ...
                    switch (tipo) {
                                case (int) 2054:
                                    ...
                                    System.out.println("Longitud de la direccion de hardware (HLEN): " + Byte.toUnsignedInt(packet[18]));
                                    System.out.println("Longitud de la direccion de protocolo (PLEN): " + Byte.toUnsignedInt(packet[19]));
                                ...
                                case (int) 2048:
                                    ...
                                    System.out.println("Longitud de la cabecera: " + (ip.getHeader().getIhlAsInt() * 32) + " bits.");
                    ...
                    if(i_g==0) System.out.println("Destinatario Individual");
                    else System.out.println("Destinatario Grupal");
                    if(c_r==0) System.out.println("Comando");
                    else    System.out.println("Acuse");
                    ...
                    if((packet[16]&0x01)==0){
                        ...
                        if(((packet[16]>>1)&0x01)==0){
                            ...
                            if(tipo>3){
                                ...
                                switch(codigo){
                                    case 0: System.out.println("00: Listo para recibir");
                                    break;
                                    case 1: System.out.println("01: Rechazo (REJ)");
                                    break;
                                    case 2: System.out.println("10: Receptor no listo para recibir");
                                    break;
                                    case 3: System.out.println("11: Rechazo Selectivo");
                                    break;
                                }
                                System.out.println("No. secuencia de la proxima trama esperada N(R) (7 bits): "
                                        +convertirDecimalABinarioLongitud((packet[17]>>1)&0x7f,7)+", Decimal: "
                            ...
                            switch(codigo){
                                case 0: System.out.println("Comando UI Respuesta UI --> Informacion sin numerar: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break; 
                                case 1: System.out.println("Comando SNRM --> Activacion de modo de respuesta normal: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 2: System.out.println("Comando DISC Respuesta RD --> Desconexion o peticion de desconexion: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 4: System.out.println("Comando UP --> Muestra sin numerar: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 6: System.out.println("Respuesta UA --> Reconocimiento sin numerar: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 16: System.out.println("Comando SIM Respuesta RIM --> Modo de peticion de informacion: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 17: System.out.println("Comando FRMR Respuesta FRMR --> Rechazo de trama: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 25: System.out.println("Comando RSET --> Reset: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 27: System.out.println("Comando SNRME  --> Activacion de modo de respuesta normal(ampliado): "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 28: System.out.println("Comando SABM Respuesta DM --> Activacion de modo de respuesta asincrona balanceada: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 29: System.out.println("Comando XID Respuesta XID --> Intercambio de ID: "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                case 30: System.out.println("Comando SABME  --> Activacion de modo de respuesta asincrona balanceada(ampliado): "
                                        +convertirDecimalABinarioLongitud(codigo,5));
                                break;
                                default: System.out.println("No hay comando de control o repuesta");
                                break;
